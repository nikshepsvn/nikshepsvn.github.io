...
window.SITE = {
  ...
  experience: [
    ...
    },
    {
      ...
      team: "Enterprise Ads",
      period: "2021 — 2024",
      description: "Scaled ad measurement, experimentation, and attribution infrastructure. Led 10+ engineers across pricing and measurement. Four awards, including the company-wide Grow the Pie award for the Ads Experimentation Platform.",
    ...
    },
    {
      ...
      period: "Fall 2020",
      description: "Moved fulfillment services from pull-based updates to an event-driven Kinesis pipeline. Deliverr was later acquired by Shopify for $2.1B.",
      domain: "deliverr.com",
    ...
    },
    {
      ...
      team: "Data Platform",
      period: "Summer 2020",
      description: "Rewrote legacy MapReduce ETL (Mongo → Snowflake) into Spark. Streaming deprecation work. Returned a full-time offer.",
      domain: "coinbase.com",
    ...
    },
    {
      ...
      period: "Fall 2019",
      description: "Real-time data pipelines for ticket marketplace events. Returned a full-time offer.",
      domain: "seatgeek.com",
    ...
    },
    {
      ...
      period: "2018 — 2019",
      description: "Data infra and ML work on the on-call / incident response stack. Returned a full-time offer.",
    ...
    },
    {
      ...
      period: "2016 — 2021",
      description: "Dean's Honour List. President's Scholarship of Distinction. Velocity Entrepreneurial Residence. 6 internships during the program — full-time offer returned on every one.",
      domain: "uwaterloo.ca",
  ...
  ventures: [
    {
      ...
      metrics: ["Kalshi grant recipient", "Builder fellow", "Polyoptions partnership"],
    ...
    },
    {
      ...
      metrics: ["Thousands of users", "500+ Discord community", "Built alongside a full-time job", "Solo build · 3 weeks", "50% cheaper than GPT-3.5 at launch"],
      url: "",
      detail: {
        paragraphs: [
  ...
  projects: [
    ...
    },
    {
      ...
      wins: ["Listed by ccusage", "In awesome-claude-code", "Inspired tokscale (5.5K ★)"],
    },
    {
      id: "P-04",
      name: "thimble",
      group: "research",
      date: "2026-08",
      tag: "research · tool calling",
      stars: 12,
      forks: 0,
      url: "https://github.com/nikshepsvn/thimble",
      summary: "State-of-the-art tool calling in 48M parameters. Your schemas in, validated calls out — malformed JSON and invented tools are structurally unreachable. $260 total build cost.",
      wins: ["Beats Cactus's Needle 2 on 3 of 5 benchmarks", "~150× less training data", "Open weights on Hugging Face"],
    },
    {
      id: "P-05",
      name: "bankai",
      ...
      wins: ["Written up by NYU Shanghai RITS", "Independently verified in the Neagari paper", "Ported to Rust as miyagi"],
    },
    {
      id: "P-06",
      ...
      summary: "RL agent exploiting information lag between Binance futures and Polymarket.",
    },
    {
      id: "P-21",
      name: "MC-Bench",
      ...
      summary: "The orchestrator behind MC-Bench, the Minecraft benchmark where LLMs build and people vote. Runs any number of model-generated builds at once on containerized servers.",
      wins: ["Built the core orchestrator: 31 of 33 commits"],
    },
    {
      id: "P-07",
      name: "veilstream",
      ...
      summary: "Streaming PII proxy for LLM chat with cryptographically-anchored reversal. Introduces PASP.",
    },
    {
      id: "P-08",
      name: "homunculus",
      ...
      summary: "A Claude Code plugin that watches how you work, learns your patterns, evolves itself.",
      wins: ["Inspired everything-claude-code's learning system (266K ★)", "Listed in awesome-claude-code"],
    },
    {
      id: "P-09",
      name: "terminal",
      ...
      summary: "Open-source self-hosted Polymarket terminal. Live book, leaderboard, self-custodial trading.",
    },
    {
      id: "P-10",
      name: "openvenice",
    ...
    },
    {
      ...
      summary: "The cloth between the tool and the model. Thins tool output for coding agents — 47% of bytes cut on 29K real Claude Code calls, nothing lost.",
      wins: ["47% fewer tool bytes on 29K real calls"],
    },
    {
      id: "P-12",
      name: "moltlaunch",
    ...
    },
    {
      ...
      summary: "Unofficial all-in-one CLI + MCP server for NEAR. One NEAR account signs across 10 chains via Chain Signatures + Intents. Built for AI agents.",
    },
    {
      id: "P-15",
      name: "blindcache",
      ...
      summary: "Encrypted memory layer for AI agents on Nillion's Blind Computer. MCP server + vault SDK. Shamir-sharded across 3 nodes — operator can't read.",
    },
    {
      id: "P-16",
      name: "blindchat",
      ...
      summary: "Private chat with portable memory. TEE inference + BlindCache encrypted vault, all in the browser — no party can read your prompts.",
    },
    {
      id: "P-17",
      name: "nemo-ai",
    ...
    },
    {
      ...
      wins: ["Featured in Business Insider", "120K+ impressions at launch", "Kalshi and Polymarket teams reached out"],
    },
    {
      id: "P-18",
      name: "sniffchain",
    ...
    },
    {
      ...
      wins: ["3,137 signups in under 4 days"],
    },
    {
      id: "P-22",
      name: "Spine",
    ...
    },
    {
      ...
      summary: "Near real-time interactive video. AI-native world-building system.",
    },
  ],
