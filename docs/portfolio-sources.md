...
| homunculus | Inspired ECC’s learning system; Hook-based observation; Portable learned instincts | [Source 1](https://github.com/affaan-m/everything-claude-code/blob/main/skills/continuous-learning-v2/SKILL.md#related); [Source 2](https://github.com/humanplane/homunculus#the-v2-solution); [Source 3](https://github.com/humanplane/homunculus#commands) |
| terminal | Self-custodial trading; Live order books via SSE; No third-party relayer | [Source 1](https://github.com/humanplane/terminal#wallet--trading-optional); [Source 2](https://github.com/humanplane/terminal#markets-view); [Source 3](https://github.com/humanplane/terminal) |
| openvenice | Visual model workflows; Agent-built workflow canvas; No backend required | [Source 1](https://github.com/nikshepsvn/openvenice#workflows); [Source 2](https://github.com/nikshepsvn/openvenice#playground); [Source 3](https://github.com/nikshepsvn/openvenice#why-openvenice) |
| scrim | 47% fewer bytes on 29K calls; Recoverable originals; Fail-open · standard library only | [Source 1](https://github.com/nikshepsvn/scrim/blob/main/docs/eval.md); [Source 2](https://github.com/nikshepsvn/scrim#nothing-is-lost); [Source 3](https://github.com/nikshepsvn/scrim) |
| moltlaunch | ERC-8004 agent identity; Trustless escrow on Base; Featured in The AI Journal | [Source 1](https://moltlaunch.com/docs/protocol/overview); [Source 2](https://aijourn.com/inside-the-gig-economy-built-for-ai-moltlaunch/) |
| updownarena | Order-book depth + slippage; Isolated bot execution; Python trading SDK | [Source 1](https://github.com/humanplane/updownarena#trading); [Source 2](https://github.com/humanplane/updownarena#how-it-works); [Source 3](https://github.com/humanplane/updownarena#sdk-usage) |
| near-hydra | One account · 10 chains; 21 MCP tools; Read-only by default | [Source 1](https://github.com/nikshepsvn/near-hydra#chain-support-matrix); [Source 2](https://github.com/nikshepsvn/near-hydra#tools-21-total); [Source 3](https://github.com/nikshepsvn/near-hydra) |
| blindcache | Shamir-shared storage; MCP server + vault SDK; Optional TEE summarization | [Source 1](https://github.com/nikshepsvn/blindcache#what-we-use-from-nillion-and-what-we-dont-yet); [Source 2](https://github.com/nikshepsvn/blindcache); [Source 3](https://github.com/nikshepsvn/blindcache#architecture-in-one-diagram) |
| blindchat | In-browser embeddings; Native + compat memory tools; Portable encrypted memory | [Source 1](https://github.com/nikshepsvn/blindchat#what-is-it); [Source 2](https://github.com/nikshepsvn/blindchat#the-interesting-part-every-model-can-use-memory); [Source 3](https://github.com/nikshepsvn/blindchat) |
| nemo-ai | Fully local · SQLite + Ollama; Contradiction handling; Explainable retrieval | [Source 1](https://github.com/nikshepsvn/nemo-ai); [Source 2](https://github.com/nikshepsvn/nemo-ai#what-nemo-does-differently); [Source 3](https://github.com/nikshepsvn/nemo-ai#memory-scoring) |
| tremor | Featured in Business Insider; ~500 markets at launch; Open source + self-hostable | [Source 1](https://www.businessinsider.com/polymarket-spot-tremors-prediction-markets-ai-2025-9); [Source 2](https://github.com/sculptdotfun/tremor) |
| sniffchain | ~5K organic users; In-feed research + trading; Token risk scoring | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| clip.fun | 3,137 signups in under 4 days; Zero paid marketing | [Source 1](https://www.linkedin.com/posts/nikshepsvn_just-closed-the-waitlist-for-clip-was-targeting-activity-7353461955820417028-gQfS) |
| Spine | Self-healing coordination; Discovery + reputation | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| dreamloom | LoRAs + ComfyUI pipelines; Video + narration + music | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| Kalshi | Kalshi grant recipient; DFlow integration; API + WebSocket collaboration | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| Instacart | 4 engineering awards; Company-wide Grow the Pie award; Lift + A/B testing | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| Deliverr | Amazon Kinesis; Event-driven microservices | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| Coinbase | Terabytes processed daily; Batch + streaming; MongoDB → Parquet | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| SeatGeek | S3 + Parquet data lake; Dynamic EMR clusters; SparkSQL over HTTP | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| PagerDuty | Elixir + Spark; SQL → Kafka; Core infra + ML platform | [Source 1](https://www.linkedin.com/in/nikshepsvn) |
| University of Waterloo | Dean’s Honour List; President’s Scholarship of Distinction; Velocity Entrepreneurial Residence | Existing owner-supplied portfolio content; no additional award claims added. |
| HumanPlane | Kalshi grant recipient; Polyoptions partnership; Featured in Bloomberg | [Source 1](https://www.linkedin.com/in/nikshepsvn); [Source 2](https://www.linkedin.com/posts/nikshepsvn_happy-to-announce-humanplane-is-partnering-activity-7417939948307165184-4xT1); [Source 3](https://www.bloomberg.com/news/articles/2026-01-26/crypto-traders-flee-to-prediction-bets-after-150-billion-crash) |
| Moltlaunch | $300K+ platform revenue; ERC-8004 identity + escrow; Featured in The AI Journal | [Source 1](https://github.com/nikshepsvn/nikshepsvn); [Source 2](https://moltlaunch.com/docs/protocol/overview); [Source 3](https://aijourn.com/inside-the-gig-economy-built-for-ai-moltlaunch/) |
...
- Waterloo’s honors and residence details remain owner-supplied; public search confirmed the CS education but did not independently verify those awards. Their tags deliberately have no external verification link.
- Moltlaunch’s reported 21K agents and 70% Base share concern the broader ERC-8004 ecosystem, not Moltlaunch adoption; those figures were not added.
- Excluded unrelated Spine, Dreamloom, and CLIP namesakes. Closed-source projects use the owner’s public career profile or original launch announcements.
- RealmPlay’s launch post describes 4K context while later founder materials describe extension to 16K. The highlight says “16K context on consumer GPUs” without assigning that capability to launch day.

## Artwork

All 22 project entries have custom SVG files in `logos/projects/`, built on a 48×48 grid with a 12-unit corner radius. Marks use broad silhouettes and shared optical weight, and are inspected at 20px, 32px, and 64px on light and dark backgrounds. Original employer and venture logos remain separate. External SVG images isolate gradient IDs when a project appears in both prose and a list.
