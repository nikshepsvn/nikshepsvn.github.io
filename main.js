...
(function () {
  ...
  if (linksEl) {
    const ICONS = {
      ...
      linkedin: `<svg viewBox="0 0 16 16" width="15" height="15" fill="currentColor" aria-hidden="true"><path d="M0 1.146C0 .513.526 0 1.146 0h13.708C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.146 1.146H1.146C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zM4.944 5.5c.836 0 1.51-.678 1.51-1.51S5.78 2.48 4.944 2.48c-.835 0-1.51.678-1.51 1.51s.675 1.51 1.51 1.51zM13.5 13.414v-3.45c0-1.65-.353-2.92-2.29-2.92-1.1 0-1.78.59-2.07 1.15l-.03.02v-1.13H7.5v7.225h2.4v-3.6c0-.95.18-1.87 1.36-1.87 1.15 0 1.17 1.06 1.17 1.9v3.57h2.4z"/></svg>`, 
